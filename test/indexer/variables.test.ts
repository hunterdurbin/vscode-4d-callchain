...
describeWithFixture("indexer/variables — interprocess + process", (root) => {
  ...
  it("≥2 interprocess variables indexed", () => {
    // Mini-fixture has exactly 2; a large project has 100+. Bound is mini-floor.
  ...
  it("≥3 process variables indexed", () => {
    // Mini-fixture has exactly 3; a large project has 10+. Bound is mini-floor.
  ...
  it("aLineItems_Description (process var) is referenced when present", () => {
    ...
    // Optional probe — project evolution may rename it. If present, callers must be ≥1.
